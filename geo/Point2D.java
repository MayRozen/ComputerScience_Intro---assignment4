...
public class Point2D{
	...
	//Calculate the scale by the chosen ratio.
	...
	public void rotate(Point2D cen, double angleDegrees) {
		...
		this._x = cen.x() + x*Math.cos(angelRadians) - y*Math.sin(angelRadians);
		this._y = cen.y() + x*Math.sin(angelRadians) + y*Math.cos(angelRadians);
	}
